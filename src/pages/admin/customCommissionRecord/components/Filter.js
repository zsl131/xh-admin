...
const Filter = ({
  ...
  return (
    <Form layout="inline" onSubmit={handleSubmit}>
      ...
      <FormItem>
        {getFieldDecorator("saleFlag")(
          <Select style={{width: 120}} defaultActiveFirstOption={true} placeholder="售后标记">
            <Option value="">==全部==</Option>
            <Option value="0">无售后</Option>
            <Option value="1">有售后，可提现</Option>
            <Option value="2">有售后，不可提现</Option>
          </Select>
        )}
      </FormItem>
      <FormItem>
