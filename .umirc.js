export default {
  ...
  proxy: {
    //程序接口
    "/api": {
      "target": "http://test.example.com:9098/api/",
      "changeOrigin": true,
      "pathRewrite": { "^/api" : "" }
    },
    //编辑器上传文件路径
    "/wangeditor": {
      "target": "http://test.example.com:9098/wangeditor/",
      "changeOrigin": true,
      "pathRewrite": { "^/wangeditor" : "" }
    },
    //Upload上传文件路径
    "/publicFile": {
      "target": "http://test.example.com:9098/publicFile/",
      "changeOrigin": true,
      "pathRewrite": { "^/publicFile" : "" }
    },
    //微信调用配置
    "/wxRemote": {
      "target": "http://test.example.com:9098/wxRemote/",
      "changeOrigin": true,
